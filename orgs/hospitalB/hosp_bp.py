...
from orgs.hospitalB.access_policy import ORG_POLICIES, DEPT_POLICIES, DEPT_GATE_POLICIES
from orgs.auth_skeleton.models import db, User

ORG = "B"
HOSP_DATA_PATH = "data/"
QDRANT_PATH = "qdrant/"
DEPTS = ["cardiology", "admissions", "medicine"]
...
hosp_bp = Blueprint('hospitalB', __name__)
...
def openid_info():
    config = {
        ...
        "jwks_uri": url_for('hospitalB.jwks_keys', _external=True),
...
def dump_users():
    DUMMY_USERS = [
        {'username': 'med.n', 'dept': 'medicine', 'role': 'nurse'}, 
        {'username': 'car.p', 'dept': 'cardiology', 'role': 'physician'},
        {'username': 'car.n', 'dept': 'cardiology', 'role': 'nurse'},
    ]
